...
def add_scene_animations():
    ...
    animate_flow_arrow("Arrow_upsv_upn", [(4.98, 1.1, 1.40), (5.60, 1.1, 1.40), (5.60, -2.55, 1.15), (12.57, -2.55, 1.15), (11.90, -2.55, 1.25), (11.90, 1.0, 1.25), (12.57, 1.0, 1.40)])
...
def build_field():
    ...
    pipe_path("UPSV_to_UPN_treater_inlet", [
        ...
        (12.57, -2.55, 1.20), # подъём к уровню treater
        (11.90, -2.55, 1.20), # подход по -X к левому торцу treater
