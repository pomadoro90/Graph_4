...
def build_field():
    ...
    # Дренажная труба от крышки водяного бака к правому outlet-патрубку (фланец).
    # Траектория: крышка → вверх → вправо → вниз → к outlet.  Все углы 90°.
    # Целевой фланец: (8.28, 0.9, 1.09) — правый outlet бака.
    ...
    # Produced Water магистраль: старт от того же outlet-фланца, без ложного спуска.
    ...
    pipe_path("Produced_water_UPSV_to_KNS", [(8.10, 0.9, 0.88), (8.10, 0.9, 0.95), (8.10, 2.75, 0.95), (5.52, 2.75, 0.95), (5.52, 12.4, 0.95)], 0.11, MATS["pipe_water"])
