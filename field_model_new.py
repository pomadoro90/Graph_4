...
def add_scene_animations():
    ...
    animate_flow_arrow("Arrow_upsv_upn", [(4.98, 1.1, 1.40), (4.98, -2.55, 0.60), (12.57, -2.55, 0.60), (12.57, 1.0, 1.40)])
...
def build_field():
    ...
    pipe_path("UPSV_to_UPN_treater_inlet", [
        ...
        (4.98, 1.1, 0.40),    # спуск вниз под оборудование
        (4.98, -2.55, 0.40),  # выход на свободный южный коридор
    ...
    pipe_path("UPSV_water_tank_overflow", [
        ...
        (8.10, 0.90, 2.85),   # горизонтально к правому краю
        (8.10, 0.90, 1.09),   # спуск к outlet-патрубку
    ...
    pipe_path("Produced_water_UPSV_to_KNS", [
        ...
        (8.10, 0.90, 0.40),   # спуск под площадку
        (8.10, 3.50, 0.40),   # на север за пределами УПСВ
    ...
    pipe_path("Gas_line_UPSV_UPN", [(3.3, -0.7, 1.75), (3.3, 3.35, 2.05), (14.5, 3.35, 2.05), (14.5, 1.0, 1.9)], 0.07, MATS["pipe_gas"])
